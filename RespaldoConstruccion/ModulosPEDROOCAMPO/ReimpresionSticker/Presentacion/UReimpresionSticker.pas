...
uses
  ...
  UDAOImpresionSticker, UDMAplicacion, UDMConexion;
...
begin
  ...
  begin
     ...
     ShowMessage('Debe seleccionar el tipo de búsqueda ...');
end;
...
begin
  ...
  Frm_ReimpresionSticker.Caption:= 'Reimpresión de Stickers - [ Versión ' + VersModu + ' ]';
...
Procedure Tfrm_ReimpresionSticker.VerificarVersion(p_NombModu: string;p_VersModu: string);
begin
  DMAplicacion.VerificarAplicacion(p_NombModu,p_VersModu, 'REIMPRESIÓN DE STICKERS');
end;
