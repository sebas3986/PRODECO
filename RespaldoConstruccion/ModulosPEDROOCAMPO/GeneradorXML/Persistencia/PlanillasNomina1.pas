...
{                                             XML Data Binding                                              }
{                                                                                                           }
{         Generated on: 08/01/2016 03:06:27 p.m.                                                            }
...
{ IXMLPLANILLA_NOMINAType }
  ...
  IXMLPLANILLA_NOMINAType = interface(IXMLNode)
    ['{66762DDD-AAB7-492C-8875-4FDBAE7D3444}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{E94B08A6-1F0A-4036-80A7-FAAD60D157BD}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{5960639A-FDEC-4DA4-AE28-1880DC7FA68A}']
    { Methods & Properties }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{5F4A9B1E-D52C-4320-89AC-650D799B677E}']
    { Property Accessors }
...
{ IXMLTitulo_documentoType }
  ...
  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{47C78B67-2372-4D89-8767-F556B3871A58}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{49082B28-74D5-4FD4-9DEF-781A6CABB416}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{E31F9468-CC5D-419D-8EEB-CE0860A82FA9}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{95BFD382-2706-448C-A8F3-57672A0CC45A}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{CB41979F-5E13-48CD-89B2-9E441A41C4F7}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{B027B98C-C091-4D06-835D-3936DC556768}']
    { Property Accessors }
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{8536BC84-097F-4696-A14D-C4EFBACD76D1}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{665407EE-71B9-4CA8-B599-9026238FF3F5}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{B6230A50-B9E6-432F-A174-3408943E99E9}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{306CC6DE-3ED6-4762-9EF3-ED8FD39CE8E7}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{3663A6BE-5197-43ED-8C4D-66E158FCB99A}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{37382595-F4D3-4389-9C0D-2679406C7A78}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{BA967A73-4263-44FE-94A6-E570DCC60E55}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{CEFF3ECB-4992-4760-A3F4-40F802C97943}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{D5CBB265-FB11-4563-86AA-CF573C4009D1}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{D864D1D4-303B-4253-9845-C634F52E9CB7}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{4E5D8C01-4F4E-4AD3-A34B-F546C7DBCE89}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{C70A45B0-DC7B-471E-800E-96B3F330F846}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{B466804F-3063-4B21-9457-F97093C1224A}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{E86B9180-9A52-4131-A97A-D231D00AEB5A}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{73382BB9-DD2B-430B-AFC0-F405A692295B}']
    { Property Accessors }
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{5F6DBDFF-1EC1-42F2-BFE9-4FB32FC2F3A3}']
    { Methods & Properties }
