...
{                                             XML Data Binding                                              }
{                                                                                                           }
{         Generated on: 12/09/2016 07:26:12 a.m.                                                            }
{       Generated from: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\HistoriaLaboral.dtd   }
{   Settings stored in: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\HistoriaLaboral.xdb   }
{                                                                                                           }
{***********************************************************************************************************}

unit HistoriaLaboral;
...
{ IXMLHISTORIA_LABORALType }
  ...
  IXMLHISTORIA_LABORALType = interface(IXMLNode)
    ['{DF720C41-1B1B-47DF-8748-28B6B4BA8057}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{EE758ABB-FA8F-4A66-9973-75181AD48FEC}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{D1DD27DA-FB69-4F48-B6A8-E013092B82DD}']
    { Methods & Properties }
...
{ IXMLIdentificacion_adicionalType }
  ...
  IXMLIdentificacion_adicionalType = interface(IXMLNode)
    ['{0DF4ED5B-220D-4E8E-A957-58350C9440F8}']
    { Property Accessors }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{FE5D31A0-E772-4444-B2CF-8ACB859A806E}']
    { Property Accessors }
...
{ IXMLTitulo_documentoType }
  ...
  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{A2940B31-E555-4198-98DD-1E22837572C0}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{15526D42-BC5D-4CCE-B343-72641007C896}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{E65FD405-DF3F-480E-94EF-021FFEE7F80B}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{0CC8FDDF-8F75-43AF-B5F0-291237A1A16C}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{CFCFF91C-2041-4B8F-A01A-4DD5E8AFA0A6}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{507DE6CA-6BF2-4B7E-AFC7-A78C3C445E21}']
    { Property Accessors }
...
{ IXMLPalabras_claveType }
  ...
  IXMLPalabras_claveType = interface(IXMLNode)
    ['{4B11E4AA-83C4-4189-9FDE-3C759423680C}']
    { Property Accessors }
...
{ IXMLSeccionesType }
  ...
  IXMLSeccionesType = interface(IXMLNode)
    ['{5CEA748F-E79F-4B17-A3F4-88501B543B9A}']
    { Property Accessors }
    function Get_Seccion_1: UnicodeString;
    function Get_Seccion_2: UnicodeString;
    function Get_Seccion_3: UnicodeString;
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{31FEB95A-4B95-4642-95EA-8D9A6F79A05B}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{3CA16B91-2448-4EEF-986F-D330088E5D7F}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{CEE8C63B-B966-407A-AD87-47A8E81828AF}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{42484BBD-0216-43D4-8019-C43876B54C16}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{5BEB8359-C0D9-4C38-AB44-A0C907EE9917}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{3EC1D5C4-6FC1-40BE-9EF7-0FEEF86BC0FC}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{E213C966-3203-42B2-AE97-0AF485DF070F}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{8AF9B197-C9BD-4065-9A93-4DAA890EAA25}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{4D08D885-95A8-4FDE-8F27-21C685FB941F}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{50E832C4-783B-47D7-8CBA-262FED7D960A}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{0E9A42E0-4810-4D97-A640-70F52365D9DD}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{7D4DA465-20E1-4D1B-8AAC-3F0FC3D17246}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{30D8E104-69C2-4C69-819D-ADC5157FC50F}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{97C3C3BE-6164-405E-88F4-049EEB73D941}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{AD227093-A852-4782-B91F-3F026FDB135F}']
    { Property Accessors }
    function Get_Num_id: UnicodeString;
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{4AB0AFC7-C7E7-455B-AABB-031F00D0CC05}']
    { Methods & Properties }
