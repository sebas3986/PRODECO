...
{                                              XML Data Binding                                              }
{                                                                                                            }
{         Generated on: 25/07/2016 02:53:32 p.m.                                                             }
{       Generated from: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\NPlanillasNomina.dtd   }
{   Settings stored in: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\NPlanillasNomina.xdb   }
{                                                                                                            }
{************************************************************************************************************}

unit NPlanillasNomina;
...
{ IXMLPLANILLA_NOMINAType }
  ...
  IXMLPLANILLA_NOMINAType = interface(IXMLNode)
    ['{7A890B57-5FE8-4DC7-ACC0-B03D604FBDC6}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{930887F2-5AD4-4EB2-8295-9809E3D9656F}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{9CCA17F9-263A-4EAF-84DC-62F735921EE5}']
    { Methods & Properties }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{97113991-4C51-45A5-8A47-840C3612BCEB}']
    { Property Accessors }
...
{ IXMLTitulo_documentoType }
  ...
  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{9E5A2F6B-17C4-427C-B9C0-460DEC6E2801}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{F45FE4A1-8DF1-4C1D-8EB4-44783E39A2D5}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{A632BC54-E263-4DC0-949D-5F507E2C5D9F}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{721D52A7-3C23-4480-AEEE-6F047C4BD3E5}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{CA4C15F8-D2F0-4F90-9489-C63F1A4E97A5}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{A0E80E53-247F-4AC6-AD29-C60B0A10B4C9}']
    { Property Accessors }
...
{ IXMLPalabras_claveType }
  ...
  IXMLPalabras_claveType = interface(IXMLNode)
    ['{A7B1D8BE-FB8C-423D-9D03-4F92C57928DC}']
    { Property Accessors }
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{A1C47D33-49BC-4909-9277-2F0D3326CCFA}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{9A65CBE9-A140-4F35-809D-B9A23D009BD0}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{32551FC5-82AA-4B4A-ADE4-290D128A8AB3}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{E5356D3B-6D33-46F4-A1C3-5C814067066B}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{200309D9-04A3-475A-8083-D7CC1B32A632}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{E3346E57-3B58-4096-B03C-5845DFF47CB4}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{6C83F52D-17F5-49CA-B9A1-25593AEF21AA}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{F4350C2E-DD35-42B6-A0F1-0EFB449F992E}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{4B822EE4-D3A2-432B-9735-C7A30209F991}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{90DFFCAA-1F7D-428E-9982-3F1B4DDE028D}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{D35466AE-A911-4FFD-AC28-697C47DE9C22}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{6514D5C5-900B-4ADB-B626-DE01F4400EBF}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{90DD6BB6-2DBB-4BB8-8EE5-358277B807EF}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{464AE585-B43D-4C58-AE3C-25F8993B886E}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{F62D3CBA-0D78-4052-9C18-F98C8851B929}']
    { Property Accessors }
    function Get_Fecha_nomina: UnicodeString;
    function Get_Num_id: UnicodeString;
    function Get_Tipo: UnicodeString;
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{00B5271E-B24D-4AE6-8BAF-A4C2DF5F8EB4}']
    { Methods & Properties }
...
function TXMLPalabras_claveType.Get_Fecha_nomina: UnicodeString;
begin
  Result := ChildNodes['fecha_nomina'].Text;
end;

procedure TXMLPalabras_claveType.Set_Fecha_nomina(Value: UnicodeString);
begin
...
function TXMLPalabras_claveType.Get_Tipo: UnicodeString;
begin
  Result := ChildNodes['tipo'].Text;
end;

procedure TXMLPalabras_claveType.Set_Tipo(Value: UnicodeString);
begin
