...
{                                              XML Data Binding                                              }
{                                                                                                            }
{         Generated on: 25/07/2016 03:54:11 p.m.                                                             }
...
{ IXMLSEGURIDAD_SOCIALType }
  ...
  IXMLSEGURIDAD_SOCIALType = interface(IXMLNode)
    ['{0F01C80F-437C-4A15-B685-C644A46C6501}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{902EE742-EAD5-4229-A2DD-6F2A53461640}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{480344F0-FB1A-402B-B71C-840E455C7007}']
    { Methods & Properties }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{58E42BBE-711F-4B67-A419-00C9AA7B84C9}']
    { Property Accessors }
...
{ IXMLTitulo_documentoType }
  ...
  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{286DD14C-D0A7-4C4B-B5E9-1657BF4B664E}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{13C6E111-D464-4583-8698-8BBF484BF4DA}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{E590D638-E116-4DED-94A0-2BF30DF99620}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{28B2543C-F417-49C1-8EE3-5455EE808D33}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{078EE8E5-DE11-4CAC-8395-83CE2A116521}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{259685EE-E0B9-4199-B529-2046CEC30776}']
    { Property Accessors }
...
{ IXMLPalabras_claveType }
  ...
  IXMLPalabras_claveType = interface(IXMLNode)
    ['{7E37A3E6-D0D4-4F80-879C-92631A416004}']
    { Property Accessors }
    function Get_Entidad: UnicodeString;
    function Get_Periodo_cotizacion: UnicodeString;
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{42B9CF77-DE0A-4052-ADCB-70FA8F69B30B}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{B3C4967F-780D-422E-BC67-8615BC34F294}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{1A7C189B-3294-4218-B210-E89A6E2DE8C9}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{FDA84FE6-291C-4AF4-B9DF-CEFAF52968B3}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{78522525-E762-4BF0-81C0-4F223E1B6D58}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{C378BB29-E3C1-459C-AD5B-E25CEE8DCD6F}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{0A6A05D7-FA81-44AF-8264-BE71681EF8F8}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{238753C5-0141-4298-AA14-B2983E34A7DD}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{AB9007E4-3F6B-45EC-B062-7BFA6D63415A}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{D785569E-1740-4A2F-BBA4-B4377E84C2A9}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{F93577D7-250A-4694-B1A5-918CB55D7A9C}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{6FA11FA7-4207-4406-8F1D-EE42AADB0F8F}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{9AE67687-A74D-40CD-BBA2-562E094E4DA5}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{CB60850F-0F32-4F28-A764-18E5A15F15AD}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{69663A97-84A5-4DFB-8DF0-2C3655C99074}']
    { Property Accessors }
    function Get_Entidad: UnicodeString;
    function Get_Periodo_cotizacion: UnicodeString;
    function Get_Fechapago_banco: UnicodeString;
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{CACD6D07-2D25-4A09-A367-C44E1B2D4E79}']
    { Methods & Properties }
