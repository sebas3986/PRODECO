...
{                                              XML Data Binding                                              }
{                                                                                                            }
{         Generated on: 05/08/2016 12:20:50 p.m.                                                             }
...
{ IXMLSEGURIDAD_SOCIALType }
  ...
  IXMLSEGURIDAD_SOCIALType = interface(IXMLNode)
    ['{4A6432E9-B462-42FF-8FF7-DC49665FE27A}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{87E5C932-039B-428F-8021-81F6E6D77C43}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{422782EC-E224-40A4-8FCD-B382EF44D67D}']
    { Methods & Properties }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{56A42B20-0E9D-4EA1-99BC-3D33B3253DC9}']
    { Property Accessors }
...
{ IXMLTitulo_documentoType }
  ...
  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{329C2FC9-0362-4BE1-B2CF-C9AD472DB540}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{3E814696-964A-4519-BF12-7B96B193A439}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{C5BC5A55-D4A1-453F-82EC-8FE4C23932E2}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{BFBE2AA9-0AB3-4D3C-B1EF-5D270190611A}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{AA45D959-4810-4CEB-8FD9-E678B619C189}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{297E0B78-8A41-4099-AC0A-BA25DBA01024}']
    { Property Accessors }
...
{ IXMLPalabras_claveType }
  ...
  IXMLPalabras_claveType = interface(IXMLNode)
    ['{13DE9EB3-D043-4876-9F97-AE861AEF52CE}']
    { Property Accessors }
    function Get_Entidad: UnicodeString;
    function Get_Periodo_cotizacion: UnicodeString;
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{DED5516E-05B1-473A-B010-145604614BB5}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{9C052ACF-8E4D-406C-BC95-79C6FC7EBE3D}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{70272937-0D0E-448D-8907-A35C348EC710}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{2E4BC65D-E15E-4507-AD5A-9E790015D2C0}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{517BB1AE-B98A-4B2F-AC05-3BF9FA7F17DA}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{B8ADE728-D6DF-4F2E-A90B-B5BE9C72918D}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{8DC6E3A1-8C7F-4490-9E8C-E76B12BA3FA5}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{CB58BFEA-833B-4325-AD62-27C549022FD5}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{6B04AF38-6E22-484E-95B9-3F5CDE301BBC}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{FD1B4CCA-D5BF-4E8E-9E2B-298BD7B276DA}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{AA5F32C0-1972-4495-A199-F909E7F2BB66}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{3179ADAB-0CDE-477D-B7D9-39055FD8FAEE}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{80FB2546-FF71-4ED9-B302-033198B638B5}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{74EDAD6B-AC5F-485B-A35F-C7429E4B6599}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{61F30B96-B608-4949-8C4C-96A6B82E715A}']
    { Property Accessors }
    function Get_Entidad: UnicodeString;
    function Get_Periodo_cotizacion: UnicodeString;
    function Get_Fechapago_banco: UnicodeString;
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{0066A02B-9FE2-4CC0-8CE4-F159C8F97FDB}']
    { Methods & Properties }
