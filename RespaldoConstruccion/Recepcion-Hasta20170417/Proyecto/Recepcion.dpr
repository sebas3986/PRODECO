...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('El Módulo de Recepción ya se encuentra en ejecución.'
                        + #10#13
  ...
  begin
    Application.MessageBox('No se permite ejecutar el Módulo de Recepción desde esta instancia.'
                        + #10#13
