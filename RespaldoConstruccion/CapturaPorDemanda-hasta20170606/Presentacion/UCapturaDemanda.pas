...
uses
  ...
  UFTP, UCliente, UProcesoCaptura, ULogin, UDMConexion, UGlobales, FPGenerales;
...
begin
  try
    ...
    begin
      Application.MessageBox('Error, no se estableció conexión con el FTP. Favor Verificar. ',
                              'Captura de Información por Demanda',MB_OK OR MB_ICONERROR);
      Application.Terminate;
    end;
  except
    on e:exception do
    begin
      Application.MessageBox(PChar(e.Message), 'Captura de Información por Demanda',MB_OK OR MB_ICONERROR);
      Application.Terminate;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    stgInfoImagen.Cells[1,6]:= UsuaAcce;
