...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('El Módulo de Devolución de Estado ya se encuentra en ejecución.'
                            + #10#13 + 'No se permite crear más de una instancia del Módulo en Memoria.',
                             'Devolución de Estado',MB_OK OR MB_ICONERROR);
  ...
  begin
    Application.MessageBox('No se permite ejecutar el Módulo de Devolución de Estado desde esta instancia.'
