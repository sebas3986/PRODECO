  ...
  begin
    ...
    begin
      ...
      {LAS 2 SIGUIENTES LINEAS SON PARA FORZAR A QUE SE MUESTRE LA BARRA DE DESPLAZAMIENTO YA
        QUE EL OBJETO DGBGRID TIENE UN BUG. HAY QUE HACER QUE SE ACTIVE EL METODO RESIZE}
...
begin
  ...
  {LA SIGUIENTE SENTENCIA OCULTA LA BARRA DE DESPLAZAMIENTO DEL GRID PORQUE CUANDO SE LIMPIA
   NO QUITA DICHA BARRA}
