...
type
  ...
  TImagen = class
    private
      ...
      {GETTERS AND SETTERS}
      function  GetIdFolio ():int64;
      procedure SetIdFolio (Valor:int64);
      ...
      function  GetNombreImagen():string;
      procedure SetNombreImagen(Valor:string);
    ...
    public
      ...
      property IdFolio       : int64     read GetIdFolio        write SetIdFolio;
      ...
      property NombreImagen  : string    read GetNombreImagen   write SetNombreImagen;
...
function  TImagen.GetIdFolio():int64;
begin
  Result := FIdFolio;
end;

procedure TImagen.SetIdFolio(valor:int64);
begin
  FIdFolio := valor;
end;
...
function  TImagen.GetNombreImagen():string;
begin
  Result := FNombreImagen;
end;

procedure TImagen.SetNombreImagen(Valor:string);
begin
  FNombreImagen := Valor;
end;
