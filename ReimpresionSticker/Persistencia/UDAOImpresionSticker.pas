...
type
  TDAOImpresionSticker = class(TDataModule)
    ...
    strngfldReimpresionStickerCodigoMCarpeta: TStringField;
    frxCarpetaAleta1: TfrxReport;
    strngfldReimpresionStickerCodigoMCarpetaAleta: TStringField;
  private
...
begin
  try
    ...
    begin
         ...
         SQL.Add('      ORDER BY 9 ');
         Open;
         if not cdsImpresionSticker.IsEmpty then
         begin
       ...
       begin
         ...
         case Tipo of
                ...
                2 : begin
                      ...
                      SQL.Add(Format('INNER JOIN %s.SerieDocumental SD ON (SD.idSerieDocumental = CR.idSerieDocumental) ',
                                      [DMConexion.Esquema]));
                ...
                3 : begin
                      ...
                      SQL.Add('                     THEN CAL.CodigoCarpetaAleta ');
                      SQL.Add('                     ELSE CAL.CodigoCarpetaAleta || '' - '' || CR.clasecarpeta || '' - '' || CR.secuenciaclase');
                      SQL.Add('                END AS CodigoMCarpetaAleta,  ');
                      SQL.Add('       CodigoCarpetaAleta, DescripcionSubSerieDocumental ');
                      SQL.Add(Format('FROM %s.Carpeta CR',[DMConexion.Esquema]));
                      SQL.Add(Format('INNER JOIN %s.CarpetaAleta CAL ON (CAL.idCarpeta = CR.idCarpeta)',
                                      [DMConexion.Esquema]));
                      SQL.Add(Format('INNER JOIN %s.SerieSubSerie SSS ON (SSS.idSerieSubSerie = CAL.idSerieSubSerie)',
                                      [DMConexion.Esquema]));
           ...
           begin
             ...
             case Tipo of
                     ...
                     2 : begin
                           ...
                           cdsReimpresionSticker.FieldByName('CodigoMCarpeta').AsString := FieldByName('CodigoMCarpeta').AsString;
                     ...
                     3 : begin
                           ...
                           cdsReimpresionSticker.FieldByName('CodigoMCarpetaAleta').AsString := FieldByName('CodigoMCarpetaAleta').AsString;
                           ...
                           frxCarpetaAleta1.PrepareReport;
                           frxCarpetaAleta1.Print;
                         end;
             end;
         end;
    end;
