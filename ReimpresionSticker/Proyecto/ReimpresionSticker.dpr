...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('El Módulo de Reimpresión de Stickers ya se encuentra en ejecución.'
                            + #10#13 + 'No se permite crear más de una instancia del Módulo en Memoria.',
                             'Reimpresión de Stickers',MB_OK OR MB_ICONERROR);
  ...
  begin
    Application.MessageBox('No se permite ejecutar el Módulo de Reimpresión de Stickers desde esta instancia.'
