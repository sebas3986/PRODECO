...
uses
  ...
  UCarpetaCarpetaDigi, UDAOCarpetaDigital,  Ucliente, UAplicacion,  UDMConexion;
type
  ...
  TProcesoCarpetaDigi = class
    ...
    public
      ...
      Function VerificarVersion(p_VersModu: string): boolean;
...
begin
  ...
  begin
    ...
    if FDatosArbolSelector.isempty then
      Result := 'LA CARPETA NO TIENE INFORMACIÓN DE IMÁGENES ... '
  end;
end;
...
Function TProcesoCarpetaDigi.VerificarVersion(p_VersModu: string): boolean;
begin
  FDatosAplicacion.ConfigurarAplicacion('MODULOCARPETADIGITAL');
