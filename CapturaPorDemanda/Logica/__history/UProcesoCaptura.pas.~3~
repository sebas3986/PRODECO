...
uses
  ...
  UDAOCaptura, UFolioCaptura,URegistroCaptura, UFTP, UImagen,Ucliente, UDMAplicacion;
...
begin
  DMAplicacion.VerificarAplicacion(p_NombModu,p_VersModu, 'CAPTURA POR DEMANDA');
end;
