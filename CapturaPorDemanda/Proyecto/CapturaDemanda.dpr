...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('El Módulo de Captura por Demanda ya se encuentra en ejecución.'
  ...
  begin
    Application.MessageBox('No se permite ejecutar el Módulo de Captura por Demanda desde esta instancia.'
