...
uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, DAOGeneradorXML, UFTP,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.ComCtrls, XMLHistoriaLaboral, PlanillasNomina,
  NSeguridadSocial,IdIPWatch,  Xml.xmldom, Xml.XMLIntf, Xml.Win.msxmldom, Xml.XMLDoc,
  UDMConexion, UDMAplicacion;
...
begin
  ...
  DMGeneradorXML.DatosPersona(DMGeneradorXML.cdsFoliosXML.FieldByName('idFolio').AsInteger);
  DMGeneradorXML.PlanillaIndices(DMGeneradorXML.cdsFoliosXML.FieldByName('idFolio').AsInteger, 1);
  DMGeneradorXML.AletasFolio(DMGeneradorXML.cdsBuscarCodigo.FieldByName('idCarpeta').AsInteger);
  with HistoriaLaboral.Contenido.Add do
     begin
       NombreImagen := Copy(DMGeneradorXML.cdsFoliosXML.FieldByName('NombreImagen').AsString, 1, Length (DMGeneradorXML.cdsFoliosXML.FieldByName('NombreImagen').AsString)-4);
       DMGeneradorXML.cdsPlanillaIndices.First;
