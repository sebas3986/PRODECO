...
{                                             XML Data Binding                                              }
{                                                                                                           }
{         Generated on: 08/01/2016 03:50:37 p.m.                                                            }
{       Generated from: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\SeguridadSocial.dtd   }
{   Settings stored in: D:\TM_UNIANDES_BPO\TRUNK\Aplicacion\GeneradorXML\Persistencia\SeguridadSocial.xdb   }
{                                                                                                           }
{***********************************************************************************************************}

unit SeguridadSocial;
...
{ IXMLSEGURIDAD_SOCIALType }
  ...
  IXMLSEGURIDAD_SOCIALType = interface(IXMLNode)
    ['{2D606351-FB49-4506-BFBB-6797E1E5F5F7}']
    { Property Accessors }
...
{ IXMLContenidoType }
  ...
  IXMLContenidoType = interface(IXMLNode)
    ['{B916C33F-397C-4560-B83E-987CCC6FE16A}']
    { Property Accessors }
...
{ IXMLContenidoTypeList }
  ...
  IXMLContenidoTypeList = interface(IXMLNodeCollection)
    ['{3E0415CB-49A3-4421-9842-803E1594A8B6}']
    { Methods & Properties }
...
{ IXMLTipo_documentalType }
  ...
  IXMLTipo_documentalType = interface(IXMLNode)
    ['{B35DB583-A177-4D56-88F4-ED073E9655ED}']
    { Property Accessors }
    function Get_Seridocumental: UnicodeString;
    procedure Set_Seridocumental(Value: UnicodeString);
    { Methods & Properties }
    property Seridocumental: UnicodeString read Get_Seridocumental write Set_Seridocumental;
  end;

{ IXMLTitulo_documentoType }

  IXMLTitulo_documentoType = interface(IXMLNode)
    ['{DEF67EE8-091E-4F94-AC31-E03CE6550701}']
    { Property Accessors }
...
{ IXMLAutor_emisorresponsableType }
  ...
  IXMLAutor_emisorresponsableType = interface(IXMLNode)
    ['{23B1EED6-86EE-4DB1-82A2-EAD09D9B9ADA}']
    { Property Accessors }
...
{ IXMLClasificacion_accesoType }
  ...
  IXMLClasificacion_accesoType = interface(IXMLNode)
    ['{EEE459BC-C19E-4A23-AAAC-0AE96029B608}']
    { Property Accessors }
...
{ IXMLFecha_creacionType }
  ...
  IXMLFecha_creacionType = interface(IXMLNode)
    ['{FFF1E3E3-4FC4-4C1B-BE34-7CE8B5D56006}']
    { Property Accessors }
...
{ IXMLFolio_electronicoType }
  ...
  IXMLFolio_electronicoType = interface(IXMLNode)
    ['{AA00E280-D7DB-4DED-8B4B-AC9AB1B5DE5A}']
    { Property Accessors }
...
{ IXMLTema_asuntoType }
  ...
  IXMLTema_asuntoType = interface(IXMLNode)
    ['{9DA7FF7D-7E7A-4D69-87C3-3F1FFB4156EE}']
    { Property Accessors }
...
{ IXMLEstructuraType }
  ...
  IXMLEstructuraType = interface(IXMLNode)
    ['{5BA4093C-18EF-42A1-953D-9F313D4FFA29}']
    { Property Accessors }
...
{ IXMLEstructuraTypeList }
  ...
  IXMLEstructuraTypeList = interface(IXMLNodeCollection)
    ['{355DF111-C230-4499-B377-E1A353A49EEA}']
    { Methods & Properties }
...
{ IXMLDescripcionType }
  ...
  IXMLDescripcionType = interface(IXMLNode)
    ['{E84FBDE4-5A3F-41C7-A72A-70FD3D827E1F}']
    { Property Accessors }
...
{ IXMLFormatoType }
  ...
  IXMLFormatoType = interface(IXMLNode)
    ['{CA5BAF39-EB34-4A86-B2D9-171AC48950A1}']
    { Property Accessors }
...
{ IXMLEstadoType }
  ...
  IXMLEstadoType = interface(IXMLNode)
    ['{6F79D77A-411D-473E-9B5F-ABB8D710F509}']
    { Property Accessors }
...
{ IXMLProceso_administrativoType }
  ...
  IXMLProceso_administrativoType = interface(IXMLNode)
    ['{36DAD5F9-5401-4F76-8BB5-C92B084765B9}']
    { Property Accessors }
...
{ IXMLUnidad_administrativa_respType }
  ...
  IXMLUnidad_administrativa_respType = interface(IXMLNode)
    ['{D8A1B662-2CF9-4FC2-A519-E8FC77DF0B23}']
    { Property Accessors }
...
{ IXMLSerieType }
  ...
  IXMLSerieType = interface(IXMLNode)
    ['{EFA3259C-9EEE-435A-A194-7217814CF7BD}']
    { Property Accessors }
...
{ IXMLContextoType }
  ...
  IXMLContextoType = interface(IXMLNode)
    ['{EA48488F-2355-4EB8-82CA-3E08B81B66CF}']
    { Property Accessors }
...
{ IXMLContextoTypeList }
  ...
  IXMLContextoTypeList = interface(IXMLNodeCollection)
    ['{DE99A1DC-4ED3-49A8-A9F9-17BE81793775}']
    { Methods & Properties }
...
{ IXMLJuridico_administrativoType }
  ...
  IXMLJuridico_administrativoType = interface(IXMLNode)
    ['{5EBB5F69-7F04-4797-BBEE-94C928458035}']
    { Property Accessors }
...
{ IXMLTecnologicoType }
  ...
  IXMLTecnologicoType = interface(IXMLNode)
    ['{70F07EEC-71B8-417F-A464-6E5C3F9C9CBE}']
    { Property Accessors }
...
{ IXMLAutenticidadType }
  ...
  IXMLAutenticidadType = interface(IXMLNode)
    ['{9793153F-E742-48C0-BA36-648479F90927}']
    { Property Accessors }
...
{ IXMLDigitalizacionType }
  ...
  IXMLDigitalizacionType = interface(IXMLNode)
    ['{50D38E63-5687-4EF4-A218-95B49C499842}']
    { Property Accessors }
...
{ IXMLIndicesType }
  ...
  IXMLIndicesType = interface(IXMLNode)
    ['{E5C132D6-8968-42E7-A974-32D643793877}']
    { Property Accessors }
    function Get_Entidad: UnicodeString;
    function Get_Periodo_cotizacion: UnicodeString;
...
{ IXMLIndicesTypeList }
  ...
  IXMLIndicesTypeList = interface(IXMLNodeCollection)
    ['{E629A0E1-5B5B-4DA7-933B-38E23EC647E3}']
    { Methods & Properties }
...
function TXMLTipo_documentalType.Get_Seridocumental: UnicodeString;
begin
  Result := ChildNodes['seridocumental'].Text;
end;

procedure TXMLTipo_documentalType.Set_Seridocumental(Value: UnicodeString);
begin
  ChildNodes['seridocumental'].NodeValue := Value;
end;
