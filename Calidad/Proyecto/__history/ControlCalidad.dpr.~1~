...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('El Módulo de Control Calidad ya se encuentra en ejecución.'
                        + #10#13
                        + 'No se permite crear más de una instancia del Módulo en Memoria.',
  ...
  begin
    Application.MessageBox('No se permite ejecutar el Módulo de Control Calidad desde esta instancia.'
                        + #10#13
