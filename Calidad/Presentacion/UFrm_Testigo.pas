...
uses
  ...
  Vcl.Forms,  Vcl.Dialogs,  Vcl.ExtCtrls,  Vcl.StdCtrls,  Vcl.DBCtrls,  Vcl.Controls,
  Vcl.Mask,   Vcl.CheckLst,
  IdIPWatch,
  UDAOControlCalidad;
        ...
        if (ArchivoImagen.Attr and faArchive = faArchive) and (ArchivoImagen.Attr and faDirectory <> faDirectory) then
          begin
            ...
            DAOControlCalidad.ImagenTestigo(idFolio, Frm_ControlCalidad.TamanoArchivo(NombreArchivo), Frm_ControlCalidad.imgImagenCalidad.Graphic.XDotsPerInch, Frm_ControlCalidad.imgImagenCalidad.Graphic.YDotsPerInch,
                                            0, DAOControlCalidad.cdsDatosFolio.FieldByName('RutaLocal').AsString, DAOControlCalidad.cdsDatosFolio.FieldByName('RutaFTP').AsString, NombreImagen,  Frm_ControlCalidad.FTP.IPServidor, DireccIP);
